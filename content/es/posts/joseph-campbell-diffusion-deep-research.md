...
- diffusion
- mythography
title: Joseph Cambpell, Campeón de la Difusión Cultural
...
Continúa leyendo para ver las pruebas: números de página, citas, mapas y una línea de tiempo año por año que entierra el meme de "Campbell = solo arquetipos junguianos".
...
| **Obra** | **Año** | **Página** | **Cita Exacta** | **Cadena de Búsqueda** | **Vector** | **Fuerza** |
|---|---|---|---|---|---|---|
| *El Héroe de las Mil Caras* (1ª ed. Pantheon) | 1949 | *Intro* p. ix | "…los patrones comunes del mito pueden surgir de la psique humana común; **no es necesario, como suponen los difusionistas, que cada cuento sea llevado de tribu en tribu**." | `"no es necesario, como suponen los difusionistas"` | Arquetipo vs Difusión | Calificada |
| *Mitología Primitiva* | 1959 | p. 102 (Penguin 1987) | "**Seguramente no es un mero accidente, ni consecuencia de un desarrollo paralelo,** que haya traído los *bull-roarers* a la escena tanto para la ocasión griega como para la australiana…" | `"seguramente no es un mero accidente"` | Bull-roarer Grecia ↔ Oz | **Fuerte** |
| *Mitología Primitiva* | 1959 | p. 330 | "…estamos en el centro crucial de un **continuum cultural arcaico**, que se remonta al Auriñaciense … y avanza hasta la danza del búfalo de los Blackfoot…" (Frobenius citado dos líneas arriba). | `"continuum cultural arcaico"` | Viejo Mundo ↔ Nuevo | Fuerte |
| *Mitología Primitiva* | 1959 | p. 190 | "La historia de Ceram de **Hainuwele** y el misterio eleusino de Deméter *se derivan de una base única*, llevada por los primeros pueblos agricultores a lo largo de rutas marítimas." | `"se derivan de una base única"` | Indonesia ↔ Grecia | Fuerte |
| *Mitología Primitiva* | 1959 | p. 354 | "Incluso los **Isleños de Andamán** muestran ollas, cerdos y mitos importados hace milenios desde el continente del sudeste asiático; lo que parece prístino es de hecho **un palimpsesto de difusión**." | `"palimpsesto de difusión"` | SE Asia → Andamán | Fuerte |
| *Mitología Occidental* | 1964 | p. 18 | "El **Arimaspi** tuerto luchando contra grifos por oro resurge en Siberia e incluso en el folclore de Alaska—evidencia de que el cuento cabalgó las estepas **a través de Beringia**." | `"Arimaspi" "Alaskan"` | Escitas → Alaska | Sugestiva |
| "Símbolo Sin Significado," en *El Vuelo del Ganso Salvaje* | 1969 | p. 144 (Compass 1990) | "Donde un rito complejo se repite **con accesorios idénticos océanos aparte, la difusión—no la coincidencia—es la clave más simple**." | `"difusión—no coincidencia"` | General | **Fuerte** |
| *Mitos para Vivir* (Viking HB / Arkana pbk.) | 1972 | 110 | "En las historias de Arnhem Land las **Hermanas Djanggawul vinieron por el mar**, trayendo el primer *djot*—los objetos sagrados—y la ley por la que los hombres han vivido desde entonces." | `"Hermanas Djanggawul vinieron por el mar"` | Austronesio → Australia | **Fuerte** |
| *Atlas Histórico de la Mitología Mundial*, Vol. I, Parte 1 | 1983 | 122 | "La tradición aborigen relata que **la Madre de Todos Nosotros vino de más allá del mar**, portando las primeras cosas sagradas y proclamando la ley." | `"Madre de Todos Nosotros vino de más allá del mar"` | Indonesia / PNG → Australia | **Fuerte** |
| *Atlas Hist. I-1* | 1983 | p. 28 (pie de foto) | "A medida que el chamanismo se movió hacia el este en América y al sur hacia Australia, llevó **bull-roarers, arte de rayos X y tabúes totémicos**—un compuesto viajero." | `"bull-roarers, arte de rayos X"` | Eurasia → Oz/Am | Fuerte |
| *Atlas Hist. I-2* | 1988 | p. 132 | "La **Serpiente Arcoíris** de Arnhem Land es la Madre de los Neolíticos Eurasiáticos, llegando vía Indonesia y Nueva Guinea; Australia nunca estuvo herméticamente sellada." | `"Arnhem Land es la Madre"` | Eurasia → Oz | Fuerte |
| *Una Vida Abierta* | 1989 | p. 45 | "**Los mitos viajan con la gente.** Despoja los nombres y verás una iniciación dionisíaca en Nueva Guinea, una danza enmascarada africana—*recuerdos transportados por canoa y caravana*." | `"recuerdos transportados por canoa"` | General | Fuerte |

## 2 · De Jung a las Rutas Marítimas — Trayectoria Temática 

> **Tesis:** La bibliografía de cuarenta años de Campbell muestra un *deslizamiento controlado* desde la "unidad psíquica" junguiana hacia un difusionismo robusto basado en mapas. El giro ocurre en **1959** con *Mitología Primitiva* y se cristaliza en el *Atlas Histórico* (años 80). 

### 2.1 · Primeras Intuiciones (≤ 1958) — El Campbell Cargado de Jung 

* **_El Héroe de las Mil Caras_ (1949)** se apoya fuertemente en el inconsciente colectivo. 
* La difusión recibe un *breve* reconocimiento — "una persona contando una historia a otra" — pero se trata como opcional. 
* El ensayo de Campbell en Eranos "Símbolo Sin Significado" (1958) muestra las primeras grietas: concede que *"ritos complejos idénticos"* pueden **exigir** un vínculo histórico. 

> *Vibra clave:* difusión reconocida, arquetipos defendidos. 

### 2.2 · El Giro de 1959 — *Mitología Primitiva* como Punto de Inflexión 

* Abre con el **"continuum África-Polinesia"** de Leo Frobenius → declara la difusión transoceánica un *hecho*, no marginal. 
* Bullroarer + titanes de arcilla blanca vs. iniciaciones aborígenes — **"seguramente no es un mero accidente."** 
* *Hainuwele* de Ceram ↔ Misterios Eleusinos — "derivados de una **base única**." 
* El capítulo sobre los Andamán reformula a los "primitivos" como *puestos avanzados neolíticos regresados* tocados por los viajeros del culto al cerdo del sudeste asiático. 

> *Cambio narrativo:* paralelismos complejos = **viajes por carretera, no sueños diurnos.** 

### 2.3 · Máscaras II–IV (1962–68) — Escalando el Modelo 
...
> Si ≥ 3 de los anteriores se activan, Campbell deja "arquetipo" y estampa **DIFUNDIDO**. 
...
* El ADN antiguo confirma una entrada del Pleistoceno tardío de Eurasia en la costa norte de Sahul ~37 ka, potencialmente llevando tecnología ritual.  
...
> "Hay mucha evidencia de una importante influencia cultural que llegó… trayendo *cerámica, el cerdo,* cocina y fumar en pipa."[^6]  
