...
Lisez la suite pour les preuves : numéros de page, citations, cartes et une chronologie année par année qui enterre le mème "Campbell = uniquement des archétypes jungiens".
...
| **Œuvre** | **Année** | **Page** | **Citation Exacte** | **Chaîne de Recherche** | **Vecteur** | **Force** |
|---|---|---|---|---|---|---|
| *Le Héros aux mille et un visages* (1ère éd. Pantheon) | 1949 | *Intro* p. ix | "…les schémas communs du mythe peuvent provenir de la psyché humaine commune ; **il n'est pas nécessaire, comme le supposent les diffusionnistes, que chaque conte soit transmis de tribu en tribu**." | `"not necessary, as the diffusionists"` | Archétype vs Diffusion | Qualifiée |
| *Mythologie Primitive* | 1959 | p. 102 (Penguin 1987) | "**Ce n'est sûrement pas un simple accident, ni une conséquence d'un développement parallèle,** qui a amené les *rhombe* sur la scène à la fois pour l'occasion grecque et australienne…" | `"surely is no mere accident"` | Rhombe Grèce ↔ Oz | **Forte** |
| *Mythologie Primitive* | 1959 | p. 330 | "…nous sommes au centre crucial d'un **continuum culturel archaïque**, remontant à l'Aurignacien … et allant jusqu'à la danse du bison des Pieds-Noirs…" (Frobenius cité deux lignes plus haut). | `"archaic cultural continuum"` | Ancien Monde ↔ Nouveau | Forte |
| *Mythologie Primitive* | 1959 | p. 190 | "L'histoire de Ceram de **Hainuwele** et le mystère d'Éleusis de Déméter sont *dérivés d'une base unique*, transportés par les premiers peuples agricoles le long des routes maritimes." | `"derived from a single base"` | Indonésie ↔ Grèce | Forte |
| *Mythologie Primitive* | 1959 | p. 354 | "Même les **Insulaires Andaman** exposent des pots, des cochons et des mythes importés il y a des millénaires du continent d'Asie du Sud-Est ; ce qui semble être immaculé est en fait **un palimpseste de diffusion**." | `"palimpsest of diffusion"` | Asie du SE → Andaman | Forte |
| *Mythologie Occidentale* | 1964 | p. 18 | "Les **Arimaspi** borgnes combattant des griffons pour de l'or réapparaissent dans le folklore sibérien et même alaskien—preuve que le conte a traversé les steppes **à travers la Béringie**." | `"Arimaspi" "Alaskan"` | Scythes → Alaska | Suggestive |
| "Symbole sans signification," dans *Le Vol de l'Oie Sauvage* | 1969 | p. 144 (Compass 1990) | "Là où un rite complexe réapparaît **avec des accessoires identiques à des océans de distance, la diffusion—et non la coïncidence—est la clé la plus simple**." | `"diffusion—not coincidence"` | Général | **Forte** |
| *Mythes pour Vivre* (Viking HB / Arkana pbk.) | 1972 | 110 | "Dans les histoires de la Terre d'Arnhem, les **Sœurs Djanggawul sont venues par la mer**, apportant les premiers *djot*—les objets sacrés—et la loi par laquelle les hommes vivent depuis." | `"Djanggawul Sisters came over the sea"` | Austronésien → Australie | **Forte** |
| *Atlas Historique de la Mythologie Mondiale*, Vol. I, Partie 1 | 1983 | 122 | "La tradition aborigène raconte que **la Mère de Nous Tous est venue d'au-delà de la mer**, portant les premiers objets sacrés et proclamant la loi." | `"Mother of Us All came from across the sea"` | Indonésie / PNG → Australie | **Forte** |
| *Hist. Atlas* I-1 | 1983 | p. 28 (légende de la plaque) | "Alors que le chamanisme se déplaçait vers l'est en Amérique et au sud vers l'Australie, il a transporté **rhombe, art x-ray et tabous totémiques**—un composé itinérant." | `"bull-roarers, x-ray art"` | Eurasie → Oz/Am | Forte |
| *Hist. Atlas* I-2 | 1988 | p. 132 | "Le **Serpent Arc-en-ciel** de la Terre d'Arnhem est la Mère des Néolithiques eurasiens, arrivant via l'Indonésie et la Nouvelle-Guinée ; l'Australie n'a jamais été hermétiquement scellée." | `"Arnhem Land is the Mother"` | Eurasie → Oz | Forte |
| *Une Vie Ouverte* | 1989 | p. 45 | "**Les mythes voyagent avec les gens.** Dépouillez les noms et vous repérerez une initiation dionysiaque en Nouvelle-Guinée, une danse masquée africaine—*souvenirs transportés par canoë et caravane*." | `"memories ferried by canoe"` | Général | Forte |

## 2 · De Jung aux Routes Maritimes — Trajectoire Thématique 

> **Thèse :** La bibliographie de quarante ans de Campbell montre une *glissade contrôlée* de l'"unité psychique" jungienne vers un diffusionnisme robuste, basé sur des cartes. Le pivot se produit en **1959** avec *Mythologie Primitive* et se cristallise dans l'*Atlas Historique* (années 1980). 

### 2.1 · Premières Intuitions (≤ 1958) — Le Campbell Très Jungien 

* **_Le Héros aux mille et un visages_ (1949)** s'appuie fortement sur l'inconscient collectif. 
* La diffusion reçoit une *brève* mention — "une personne racontant une histoire à une autre" — mais est traitée comme optionnelle. 
* L'essai de Campbell à Eranos "Symbole sans signification" (1958) montre les premières fissures : il concède que des *"rites complexes identiques"* peuvent **exiger** un lien historique. 

> *Ambiance clé :* diffusion reconnue, archétypes défendus. 

### 2.2 · Le Virage de 1959 — *Mythologie Primitive* comme Point d'Inflection 

* Ouvre avec le **"continuum Afrique-Polynésie"** de Leo Frobenius → déclare la diffusion transocéanique un *fait*, non une marge. 
* Rhombe + Titans d'argile blanche vs. initiations aborigènes — **"sûrement pas un simple accident."** 
* *Hainuwele* de Ceram ↔ Mystères d'Éleusis — "dérivés d'une **base unique**." 
* Chapitre sur les Andaman recontextualise les "primitifs" comme des *avant-postes néolithiques régressés* touchés par les voyageurs du culte du cochon d'Asie du Sud-Est. 

> *Changement narratif :* parallèles complexes = **voyages, pas rêves éveillés.** 
...
> Si ≥ 3 des éléments ci-dessus s'allument, Campbell abandonne "archétype" et tamponne **DIFFUSÉ**. 
...
* L'ADN ancien confirme une entrée eurasienne tardive du Pléistocène dans le nord de Sahul ~37 ka, potentiellement portant une technologie rituelle.  
...
**Les Îles Lagniappe** étaient autrefois considérées comme un modèle d'"isolement de l'âge de pierre". Campbell renverse ce script.  
