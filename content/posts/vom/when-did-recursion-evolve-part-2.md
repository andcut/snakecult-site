...
Importantly, he really does commit to a single, species-defining change right before we left Africa, and then nothing important since[^1]. I have two problems with that.
