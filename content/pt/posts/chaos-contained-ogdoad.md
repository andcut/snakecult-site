...
## 3 · A Ogdoade: O Conjunto de Potencial Bruto do Egito
...
Padrão: ingerir rival → prevenir ação independente → ou digerir como pacote de poder (Nehebkau) ou regurgitar em forma domada (Cronos, Zeus).
